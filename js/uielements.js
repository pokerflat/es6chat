...
export const inputChatname = document.getElementById("name-in-chat");
export const enterButton = document.getElementById("goToAuth");
export const spanRegistration = document.getElementsByClassName(
  "registration"
)[0];
